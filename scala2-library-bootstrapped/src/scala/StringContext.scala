...
case class StringContext(parts: String*) {
   ...
   */
  inline def s(args: Any*): String = ??? // fasttracked to scala.tools.reflect.FastStringInterpolator::interpolateS
  object s {
   ...
   *          use of a StringBuilder.
   */
  inline def raw(args: Any*): String = ??? // fasttracked to scala.tools.reflect.FastStringInterpolator::interpolateRaw
